...
if (self.loadReason == 'install') {
  ...
  // Enable http2
  Preferences.set('network.http.spdy.enabled.http2draft', true);
  Preferences.set('security.ssl.enable_alpn', true);

  // Disable the strict cipher checks for http2, as node 0.10 doesn't support them
  Preferences.set('network.http.spdy.enforce-tls-profile', false);
}
